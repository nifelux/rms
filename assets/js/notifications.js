(function() {
  ...
  style.innerHTML = `
    /* Toast Container - Pushed down further and highest z-index */
    .rms-toast-container { 
      position: fixed; 
      top: 100px; 
      left: 50%; 
    ...
    .rms-toast.success { border-color: #2ecc71; background: #0f2b1d; }
    .rms-toast.error { border-color: #ff1a1a; background: #2b0f0f; }
    .rms-toast.info { border-color: #3498db; background: #0f1d2b; }
    .rms-toast-icon { font-size: 1.4rem; }
    ...
    .rms-toast-message { flex: 1; font-size: 0.95rem; font-weight: 600; }
    ...
    .rms-modal-btn { padding: 12px 24px; border-radius: 8px; border: none; font-weight: 700; cursor: pointer; font-size: 0.95rem; transition: 0.2s; }
